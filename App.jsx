...
function App() {
  ...
  async function generateAnswer() {
    ...
    if (question.toLowerCase().includes("what is my name")) {
      setAnswer(storedName ? `Your name is ${storedName}.` : "I don't know your name yet. Please tell me.");
      return;
    }
    ...
    <>
      <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-4 sm:p-8">
        ...
        <footer className="w-full text-center text-sm text-gray-400 py-4 mt-12 border-t border-gray-600">
          <p>Created by <span className="font-semibold text-white"><a href="">Atharva Lohakare</a></span></p>
        </footer>
      </div>
    </>
  );
